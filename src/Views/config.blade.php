...
<div class="section-wrap-body">
    ...
    <div class="primary-form">
      <form action="{{ route('WebInstaller::final') }}" method="POST">
        @csrf
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="AppName" name="app_name" value="{{ env('APP_NAME') }}" placeholder="{{__('WebInstaller')}}" />
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
